<%@ Page Language="C#" MasterPageFile="~/Page/MasterPage.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" Title="无标题页" %>
        ...
        <td align="center" valign="middle">
           <table align="left" class="style10">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Index.aspx" 
                            Font-Underline="False">后台入口</asp:LinkButton>
                    </td>
                </tr>
                <tr>
            ...
            <asp:SqlDataSource ID="SqlDataSourceUser" runat="server" 
                ...
                SelectCommand="SELECT [User_LogName], [User_Password], [User_Issuper] FROM [User] WHERE ([User_LogName] = @User_LogName)">
                <SelectParameters>
